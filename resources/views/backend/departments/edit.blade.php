        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <form method="post" action="{{ url('admin/departments/edit/'. $getRecord->id) }}" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body">           
                  ...
                  <div class="form-group row">
                    <lable class="col-sm-2 col-form-lable">Department Name <span style="color: red;"> *</span></lable>
                      <div class="col-sm-10">
                        <input type="text" name="department_name" value="{{ $getRecord->department_name }}" class="form-control" required placeholder="Enter Department Name">
                      </div>
                  </div>       
                      ...
                      <div class="col-sm-10">
                        <select name="manager_id" id="" class="form-control" required>
                          @foreach ($getManager as $value_manager)
                            <option {{ ($value_manager->id == $getRecord->manager_id) ? 'selected' : ''}} value="{{$value_manager->id}}">{{ $value_manager->manager_name }}</option>
                          @endforeach
                        </select>
                      </div>
                  </div>
