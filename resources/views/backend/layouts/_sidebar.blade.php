...
<div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ url('public/backend/dist/img/SHR-logo.png') }}" alt="SmartHR Logo"
        height="60" width="60">
</div>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('admin/dashboard')}}" class="brand-link">
        <img src="{{ url('public/backend/dist/img/SHR-logo.png') }}" alt="AdminLTE Logo"
                ...
                @if (Auth::user()->is_role == '0')
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/interview') }}"
                            class="nav-link @if (Request::segment(2) == 'interview') active @endif">
                            <i class="nav-icon fas fa-user"></i>
                            <p>
                                Interview
                            </p>
