        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <form method="post" action="{{ url('admin/countries/add') }}" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <lable class="col-sm-2 col-form-lable">Regions Name<span style="color: red;"> *</span></lable>
                      <div class="col-sm-10">
                        <select  class="form-control" name="regions_id" required>
                          ...
                          <option value="{{$value->id}}">{{$value->regions_name}}</option>
                          @endforeach
